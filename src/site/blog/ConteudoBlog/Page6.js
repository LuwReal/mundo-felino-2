            ...
            <article className={style.articleContainer}>
                ...
                <ul className={style.articleList}>
                    <li>
                        ...
                        <img className={style.articleListImg} src='/img/blog/page6/maine-coon-1.jpg' alt="Gato da raça maine coon de cor amarela em um campo verde" title='Gato Maine Coon'/>
                    </li>
                    <li>
                        ...
                        <img className={style.articleListImg} src='/img/blog/page6/maine-coon-2.jpg' alt="Gato Cinza Maine Coon" title='Gato Maine Coon'/>
                    </li>
                    <li>
                        ...
                        <img className={style.articleListImg} src='/img/blog/page6/maine-coon-3.jpg' alt="Gato Cinza Rajado da raça Maine Coon" title='Gato Cinza Rajado Maine Coon'/>
                    </li>
