            ...
            <article className={style.articleContainer}>
                ...
                <ul className={style.articleList}>
                    <li>
                        ...
                        <p className={style.articleListText }>Apesar de serem frequentemente considerados e se auto considerarem menos "obedientes" do que cães, sua popularidade depende de países em relação aos cachorros. Em alguns países, sua população é superior, incluindo o Japão e algumas regiões na Europa. Estima-se que existam cerca de 600 milhões de gatos domésticos globalmente, isso só os que têm dono. Sem dúvida, esse número pode ser 1 bilhão (oloco, se parar pra pensar, dá por volta de 10% da população mundial).</p>
